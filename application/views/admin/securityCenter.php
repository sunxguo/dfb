...
.score-step, .score-state-left, .score-state-right, .score-btn, .mod-account-avatar{background:url('/assets/images/admin/ucenter_1.png') no-repeat 0 0;}
...
<div class="mod-ucenter-cright">
	<div id="mod-account-score" class="clearfix score-level-2 ">
		<p class="ucenter-cright-title score-title">Security Score</p>
		<div class="score-step left">
			<div class="score-state-left"></div>
			<div class="score-state-right" style="width:343px"></div>
		</div>
		<div class="score-num left" ><span id="scorenum"></span>Score!</div>
		<div class="score-btn" id="check-secure">Re-test</div>
		<!--
