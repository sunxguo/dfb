<div class="padding10 contentlist">
	<div id="appDiv" class="titA tit-bot pb5" style="">
		<div class="tabDiv">
			<div  onclick="location.href='/admin/contentList?type=essay'" class="left active">
				文章
			</div>
			<div  onclick="location.href='/admin/contentList?type=image'" class="right">
				图片集
			</div>
			<div class="clear">
			</div>
	...
	<table style="width: 100%;">
		...
		<tbody>
			...
			<tr>
				<td>
					<a href="/admin/editColumn?column=<?php echo $cont->essay_column;?>" target="_blank">
						<?php echo $columns[$cont->essay_column]->column_name;?>
					</a>
				</td>
				<td><img src="
				<?php 
					$imgs=json_decode($cont->essay_thumbnail);
					echo sizeof($imgs>0)&&isset($imgs[0]->src)?$imgs[0]->src:'';?>" style="width:98%;max-height:50px;"></td>
				<td><a href="/admin/editContent?type=essay&essay=<?php echo $cont->essay_id;?>"><?php echo $cont->essay_title;?></a></td>
				<td><?php echo $cont->essay_create_time;?></td>
				<td><?php echo $cont->essay_lastmodify_time;?></td>
				<td><?php echo $cont->essay_visits;?></td>
				<td><?php echo $contentState[$cont->essay_state];?></td>
				<td>
					<a href="/admin/editContent?type=essay&essay=<?php echo $cont->essay_id;?>">编辑</a>
