...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="/admin/loginhandler" method="post">
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img src="" id="validCodeImg" onclick="refreshCode();"> <a id="kanbuq" href="javascript:refreshCode();">看不清，换一张</a> </div>
      </div>
      <div class="row">
        <div class="formControls col-8 col-offset-3">
          <label for="online">
...
<div class="footer">Copyright 太原市风度科技有限公司</div>
